...
public class LobbyMessageUI : MonoBehaviour
{
    ...
    {
        ShowMessage("No public lobby available to quick join!");
    }
    ...
    {
        if (NetworkManager.Singleton.DisconnectReason == "" || NetworkManager.Singleton.DisconnectReason.Contains("Connection closed"))
        {
